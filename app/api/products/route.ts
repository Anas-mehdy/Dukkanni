...
export async function GET(request: NextRequest) {
  ...
  let query = supabase
    .from("products")
    .select(`
      id, name, price, image_url, is_active, sort_order, category_id, created_at, updated_at,
      categories ( id, name )
    `)
...
export async function POST(request: NextRequest) {
  ...
  const { data: product, error } = await supabase
    ...
    .select("id, name, price, image_url, is_active, sort_order, category_id, created_at")
    .single();
...
export async function PUT(request: NextRequest) {
  ...
  const { data: product, error } = await supabase
    ...
    .select("id, name, price, image_url, is_active, sort_order, category_id, updated_at")
    .single();
